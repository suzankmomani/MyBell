...
import mybell.android.com.mybell.Utils.RequestPermissionsTool;
import mybell.android.com.mybell.Utils.RequestPermissionsToolImpl;
...
public class Main2Activity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private void startCameraActivity() {
        try {
            outputFileUri = FileProvider.getUriForFile(this, getApplicationContext().getPackageName() + ".provider", createImageFile());
    ...
    private File createImageFile() throws IOException {
        ...
        String imageFileName = "ocr_";
        File storageDir = getExternalFilesDir(DATA_PATH);
    ...
    private void startOCR(Uri imgUri) {
        try {
            ...
            Bitmap bitmap = BitmapFactory.decodeFile(imgUri.getPath().replace("/external_files","/storage/emulated/0"), options);
